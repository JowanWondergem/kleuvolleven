 ...
 */
    ...
    //hides side menu when blog should show as page
    $isPage = simple_fields_value("blog_ispage"); 
    if ( $isPage == 1 )  {$sidebar_class = 'no-sidebar';}
	...
	<div class="content_wrapper <?php echo $sidebar_class; ?>">
		<div class="content">
			...
			<div class="real_content">
				...
				<div class="blog_post <?php if ( $isPage != 1 ) { echo blog_post_page;} ?><?php echo $has_thumbail; ?>">
					<div class="blog_post_wrapper">
						<h3><?php   if ( $isPage != 1 ) { the_title(); }?></h3>
						<h3 style="color: #e84c3d;"> <?php echo simple_fields_value("blog_subtitle"); ?></h3>
						<div class="<?php if ( $isPage != 1 ) {  echo "blog_post_main_content"; } ?> ">
							...
							<a <?php if ( $isPage == 1) {echo ' style="display:none;"';} ?> href="<?php echo $large_image_url[0]; ?>" rel="prettyPhoto"><?php the_post_thumbnail('blog-full', array('class' => 'blog_post_image')); ?></a>
			...
			<div class="clear"></div><!--clear -->
			<?php if ( $allaround_data['blog-related'] == 1 && $isPage != 1) echo do_shortcode('<div class="all_around_related">[aa_title]' . __('Related Posts', 'allaround') . '[/aa_title][aa_blog type="5" rows="1" category="' . implode(",",  wp_get_post_categories( get_the_ID() ) ) . '" order="rand" pagination="no" related="yes"]</div><div class="clear"></div>'); ?>
<div class="clear"></div><!--clear -->
			<?php comments_template(); ?>
			</div><!-- real_content -->
			<?php
				if ( $allaround_data['sidebar-blog'] !== 0 && $isPage != 1) {
