...
?>
<div id="comments" class="comments_wrapper clearfix" style="width:100%">
...
$fields =  array(
  ...
  'url' =>
	...
	'<div class="textarea_wrapper" style="width: 100% !important;"><span class="textarea_title">' . __( 'Comment', 'allaround' ) . '</span><textarea id="comment" name="comment" name="text" class="textarea_field"  aria-required="true"></textarea></div><!-- textarea_wrapper -->', 'title_reply' => __( 'Send Us A Message Here', 'allaround' ), 'title_reply_to'    => __( 'Leave a Reply to %s' , 'allaround' ), 'comment_notes_after' => ''));
?>
</div>
</div>