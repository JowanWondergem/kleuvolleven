...
<?php wp_footer(); ?>
<script>
//click on image will also open blog
jQuery( document ).ready(function() {
jQuery('.image_shader').click(function(el){ var bloglink = jQuery(this).prev().find(".comments a").attr("href"); window.location = bloglink; })
});
</script>
</body>
</html>